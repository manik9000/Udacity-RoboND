...
def color_thresh(img, low_thresh=(0, 0, 0), high_thresh=(160, 160, 160), type_="GROUND"):
...
def perception_step(Rover):
    ...
    ground_thresh = color_thresh(warped, type_="GROUND")
    obstacle_thresh = color_thresh(warped, type_="OBSTACLE")
    sample_thresh = color_thresh(warped,type_="SAMPLE",low_thresh=sample_low_thresh,high_thresh=sample_high_thresh)
